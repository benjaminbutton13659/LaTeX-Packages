...
\usepackage{cleveref} % smart automatic referenzing (import after hyperref!)
\usepackage{url} % smart handling of url links

\usepackage[margin=1in]{geometry}  % changes the margins on all pages (easy lanscape mode) (import after hyperref!)
